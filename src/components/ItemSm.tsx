    ...
    return (
        <div className="md:hidden">
            ...
            {open ? <motion.div
                ...
                className="absolute top-0 right-0 bg-cyan-100 ">
                <div
                    onClick={() => setOpen(open => !open)}
                    ...
                    <div className="mt-4 w-full flex flex-col items-center">
                        {
                            arr.map((e, i) => {
                                return <motion.div
                                    ...
                                    key={i} 
                                    className="cursor-pointer px-2 py-2 rounded-md flex justify-between m-2 w-[80%] bg-gradient-to-tr from-cyan-200 via-green-200 to-slate-200">
